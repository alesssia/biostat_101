...
setwd("/Users/visconti/Documents/Teaching/biostat_101/slide/img/sampling")
...
p <- p + 		
		annotate("text", x = 8, y=4, label = "Popolazione", parse = FALSE, size=7) +
		annotate("text", x = 9, y=-3.3, label = "Finestra di", parse = FALSE, size=7) +
		annotate("text", x = 8.5, y=-3.75, label = "campionamento", parse = FALSE, size=7) +
		annotate("text", x = 9.4, y=1, label = "Ineleggibile", parse = FALSE, size=7) +
 		annotate("text", x = 3.3, y=-0.1, label = "Mancata risposta ", parse = FALSE, size=7) +
